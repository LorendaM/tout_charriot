...
class LocationView extends GetView<LocationController> {
  ...
  showBtmModal(Map<String, dynamic> args,BuildContext context) {
        ...
        builder: (BuildContext context) {
          return ClipRRect(
            borderRadius: const BorderRadius.only(
              topLeft: Radius.circular(AppSizes.fourPadding),
              topRight: Radius.circular(AppSizes.fourPadding),
            ),
                        ...
                        Row(
                          ...
                          children: [
                            Row(
                              mainAxisAlignment: MainAxisAlignment.spaceBetween,
                              children: [
                                Image(image: AssetImage(args['imageEngins']), width: AppSizes.largePadding, height: AppSizes.largePadding,),
                                Column(
                                  crossAxisAlignment: CrossAxisAlignment.start,
                                  children: [
                                    Text("${frLanguage['carType']}", style: AppTextStyle.textSmall(size: 12),),
                                    Text(args['typeEngins'], style: AppTextStyle.textBold(size: 12),)
                                  ],
                                ),
                              ],
                            ),
                            Text("${args['mtnStart']} - ${args['mtnEnd']}", style: AppTextStyle.textBold(color: AppColor.greenColor, size: 13),)
                          ],
                        ),
                        Padding(
